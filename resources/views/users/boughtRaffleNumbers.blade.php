...
@else
<div class="container-fluid d-grid align-items-center justify-content-center" style="height: 150px">
    <p>Ainda não foi registrada nenhuma participação!</p>
    <a class="btn btn-secondary" href="{{ route('redirecionarHome')}}">Participar agora!</a>
</div>
@endif
