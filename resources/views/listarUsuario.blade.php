...
@section('content')
    ...
    <section class="cadastro-main">
        ...
        <div class="informacoes-cadastro">
            <h1 class="form-title">CRUD DA CONTA DO USUÁRIO</h1>
        ...
        <form class="cadastro-form" action="{{ route('updateUsuario') }}" method="POST">
            ...
            <div class="campo-formulario">
                ...
                <input class="form-input" type="text" placeholder="{{$user->cpf}}" name="cpf">
            </div>
            ...
            <div class="campo-formulario">
                ...
                <input class="form-input" type="text" placeholder="{{$user->celular}}" name="celular">
            </div>
