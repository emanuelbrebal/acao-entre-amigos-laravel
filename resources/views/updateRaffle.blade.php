    ...
    <section class="cadastro-main">
        ...
        <form class="cadastro-form" method="POST" action="{{ route('editarRifa', ['id' => $rifa->id]) }}"
            ...
            <div class="campo-formulario">
                ...
                <input class="form-input" type="time" min="" step="600" value="{{ old('horario_sorteio') }}"
                    name="horario_sorteio">
                @error('horario_sorteio')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
                ...
                @if (isset($rifa->imagem))
                    <div class="preview-imagem">
                        ...
                        <img src="{{ asset('img/raffles/' . $rifa->imagem) }}" alt="Imagem da rifa" width="140"
                            height="140" style="border: solid 2px var(--black); object-fit: cover;">
                    </div>
                @endif
