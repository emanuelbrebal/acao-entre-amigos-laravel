function atualizarArrayQuotas() {
    ...
    arrayQuotas.textContent = selectedArray.join(", ") ? selectedArray.join(", ") : "Nenhuma cota selecionada.";
    quotasCarrinho.textContent = selectedArray.join(", ") ? selectedArray.join(", ") : "Nenhuma cota selecionada.";
}
